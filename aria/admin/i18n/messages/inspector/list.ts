export const EN_INSPECTOR_LIST_MESSAGES = {
  ...
  "inspector.list.bullets": "Bulleted list",
  "inspector.list.numbers": "Numbered list",
  "inspector.list.description": "Description list",
...
export const FR_INSPECTOR_LIST_MESSAGES = {
  ...
  "inspector.list.type": "Type",
  "inspector.list.bullets": "Liste à puces",
  "inspector.list.numbers": "Liste numérotée",
  "inspector.list.description": "Liste de définitions",
